...
public class SudokuGame {
    ...
    private DatabaseReference currentBoardReference;
    ...
    public void setBoardDatabase(DatabaseReference currentBoard) {
        currentBoardReference = currentBoard;
    }
    ...
    public String getLastBoardData() {
        return lastBoardData;
    }

    private void updateCurrentBoardReference() {
        if (currentBoardReference != null) {
            String boardData = mCells.serialize();

            if (!boardData.equals(lastBoardData)) {
                Log.d(Const.TAG, "Updating firebase database with new board data: " + boardData + ".");
                lastBoardData = boardData;
                currentBoardReference.setValue(mCells.serialize());
            } else {
				Log.d(Const.TAG, "Ignoring firebase update of duplicate board data.");
			}
        }
    }
